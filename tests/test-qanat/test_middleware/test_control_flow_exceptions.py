...
from qanat.exceptions import QanatError, RejectMessage, RetryMessage
...
class TestRetryMessageInheritance:
    ...
    def test_retry_message_inherits_from_qanat_error(self):
        """RetryMessage is a subclass of QanatError."""
        assert issubclass(RetryMessage, QanatError)
    ...
    def test_retry_message_can_be_caught_as_qanat_error(self):
        """RetryMessage can be caught as QanatError."""
        try:
...
class TestRejectMessageInheritance:
    ...
    def test_reject_message_inherits_from_qanat_error(self):
        """RejectMessage is a subclass of QanatError."""
        assert issubclass(RejectMessage, QanatError)
    ...
    def test_reject_message_can_be_caught_as_qanat_error(self):
        """RejectMessage can be caught as QanatError."""
        try:
            raise RejectMessage
        except QanatError as exc:
