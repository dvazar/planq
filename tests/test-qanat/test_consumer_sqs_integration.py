"""Integration tests for QanatConsumer with SQS provider and ElasticMQ."""
...
from qanat.middleware import DeadlineMiddleware
...
async def process_one_message(
    consumer: QanatConsumer, broker: SqsBroker, queue_url: str
) -> None:
...
async def test_consumer_deadline_middleware_rejects_expired_message(
    ...
    consumer = QanatConsumer(sqs_broker, middlewares=[DeadlineMiddleware()])
